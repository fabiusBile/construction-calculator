...
async function getCalculatorData(): Promise<CalculatorData> {
    ...
    const frameCalculator = new FrameCalculator(getFrameMaterials(pricesWorkbook.getWorksheet(sheetNames.FRAME_MATERIALS_WORKSHEET_NAME)))
    ...
    const sideMaterials = getSideMaterials(pricesWorkbook.getWorksheet(sheetNames.LIGHT_SIDE_MATERIALS_WORKSHEET_NAME));
 ...
 * @constructor
 */
export default function LightSideLetters() {
